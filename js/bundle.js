...
const{log,logE,turnOffNonErrorLogs}=require("../node_modules/simple-log-kit/index");log("tyvty");logE("tests 568767");turnOffNonErrorLogs();log("? ");document.getElementById("note_button").onclick=function(){logE("tests")};function drawNote(){logE("testhvhgvhg")}function drawChord(){log("testhgbhgv 2")}function drawScale(){alert("TODO")}
