...
function build_all_notes(){
	...
	for(octave = -1 ; octave <= octaves; octave++){
		var j;
		for(j = 0 ; j < Note.ALL_NOTE_NAME_TYPES.length; j++){
			var note_name = Note.ALL_NOTE_NAME_TYPES[j].sharp_name;
			var note = new Note.Note(Note.ALL_NOTE_NAME_TYPES[j], note_value, octave);
