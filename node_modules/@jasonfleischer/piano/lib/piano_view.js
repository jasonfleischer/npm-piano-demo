...
class PianoView {
	...
	buildCanvases() {
		...
		let height = this.calculateHeight(width, this.number_of_white_keys);
	...
	resize(newWidth) {
		...
		var newHeight = 230;//this.calculateHeight(newWidth, this.number_of_white_keys);//this.HEIGHT * this.number_of_white_keys/52;///this.white_key_height;// * (this.HEIGHT/newWidth);
	...
	draw(){
		...
		ctx = this.white_keys_canvas.getContext("2d");
		var j;
	...
	calculateHeight(width, number_of_white_keys) {
		return this.HEIGHT * number_of_white_keys/52
	}
