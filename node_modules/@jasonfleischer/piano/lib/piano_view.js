...
class PianoView {
	...
	buildCanvases() {
	    ...
	    this.white_keys_canva = document.createElement('canvas'); 
	    this.white_keys_canva.id = "piano_white_keys_canvas_"+this.id;
	    this.white_keys_canva.style.position = "absolute"
	    this.white_keys_canva.style.left = "0px"
	    this.white_keys_canva.style.right = "0px"
	    this.white_keys_canva.style.width = width;
		this.white_keys_canva.style.height = height;
	    pianoView.appendChild(this.white_keys_canva);
