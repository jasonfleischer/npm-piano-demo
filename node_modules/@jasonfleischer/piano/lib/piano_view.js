...
class PianoView {
	...
	addEventListener() {
		...
		log.e("??/ " + this.min_midi_value + ' ' + this.max_midi_value);
		...
		pianoView.addEventListener("click", function(event){
		    ...
		    var i;
		    log.e("?? " + this.min_midi_value + ' ' + this.max_midi_value);
		    log.e("?i? " + range.min + ' ' + range.max);
		    for(i=range.min; i<=range.max; i++){
		    	
		    	var key = this.midi_value_to_piano_key_map[i];

		    	log.e("looping key " + key.note.to_string());
		    ...
		    if(foundKey == undefined){
		    	...
		    	log.e("found key " + key.note.to_string());
		    }
