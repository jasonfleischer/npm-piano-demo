...
class PianoView {
	...
	buildCanvases() {
	    ...
	    this.canvas_background.style.width = width;
		this.canvas_background.style.height = height;
	    ...
	    this.white_keys_canvas.style.width = width;
		this.white_keys_canvas.style.height = height;
	    ...
	    this.black_keys_canvas.style.width = width;
		this.black_keys_canvas.style.height = height;
		...
		pianoView.style.width = width;
		pianoView.style.height = height;
		//pianoView.width=this.WIDTH;
		//pianoView.height=this.HEIGHT;
	}
